             ...
             <div class="container">
                 ...
                 <div class="showcase">
                     ...
                     <div class="sc-child sc-center-position">
                         ...
                         <figure><img src="{{ URL::asset('frontend/assets/images/about-us/bn04.jpg') }}" alt="" width="622"
                                 height="656"></figure>
                     </div>
                 ...
                 <ul class="testimonial-list biolife-carousel"
                     ...
                     <li>
                         <div class="testml-elem">
                             <div class="avata">
                                 <figure><img src="{{ URL::asset('frontend/assets/images/about-us/author-01.png') }}" alt="" width="217"
                                         height="217"></figure>
                             </div>
                     ...
                     <li>
                         <div class="testml-elem">
                             <div class="avata">
                                 <figure><img src="{{ URL::asset('frontend/assets/images/about-us/author-02.png') }}" alt="" width="217"
                                         height="217"></figure>
                             </div>
                             <p class="desc">The point of using Lorem Ipsum is that it has a more-or-less normal
                                 distribution of letters, as opposed to using 'Content here, content here', making it
                     ...
                     <li>
                         <div class="testml-elem">
                             <div class="avata">
                                 <figure><img src="{{ URL::asset('frontend/assets/images/about-us/author-03.png') }}" alt="" width="217"
                                         height="217"></figure>
                             </div>
                             <p class="desc">The point of using Lorem Ipsum is that it has a more-or-less normal
                                 distribution of letters, as opposed to using 'Content here, content here', making it
                     ...
                     <li>
                         <div class="testml-elem">
                             <div class="avata">
                                 <figure><img src="{{ URL::asset('frontend/assets/images/about-us/author-01.png') }}" alt=""
                     ...
                     <li>
                         <div class="testml-elem">
                             <div class="avata">
                                 <figure><img src="{{ URL::asset('frontend/assets/images/about-us/author-02.png') }}" alt=""
                                         width="217" height="217"></figure>
                             </div>
                             <p class="desc">The point of using Lorem Ipsum is that it has a more-or-less normal
                                 distribution of letters, as opposed to using 'Content here, content here', making it
                     ...
                     <li>
                         <div class="testml-elem">
                             <div class="avata">
                                 <figure><img src="{{ URL::asset('frontend/assets/images/about-us/author-03.png') }}" alt=""
                                         width="217" height="217"></figure>
                             </div>
                             <p class="desc">The point of using Lorem Ipsum is that it has a more-or-less normal
                                 distribution of letters, as opposed to using 'Content here, content here', making it
